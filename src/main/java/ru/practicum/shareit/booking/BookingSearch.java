...
class All implements BookingSearch {
    ...
    public List<Booking> getBookings(long ownerId, BookingRepository bookingRepository) {
        return bookingRepository.findByBooker_Id(ownerId, Sort.by(Sort.Direction.DESC, "start_date"));
    }

    @Override
    public List<Booking> getBookingsByItemsOwner(long ownerId, BookingRepository bookingRepository) {
        return bookingRepository.findByBooker_IdAndItem_Owner_IdOrderByStartDesc(ownerId);
    }
}
...
class Current implements BookingSearch {
    ...
    public List<Booking> getBookingsByItemsOwner(long ownerId,BookingRepository bookingRepository) {
        return bookingRepository
                .findByBooker_IdAndItem_Owner_IdInFutureOrderByStartDesc(ownerId, LocalDateTime.now());
    }
}
...
class Past implements BookingSearch {
    ...
    public List<Booking> getBookingsByItemsOwner(long ownerId,BookingRepository bookingRepository) {
        return bookingRepository
                .findByBooker_IdAndItem_Owner_IdInPastOrderByStartDesc(ownerId, LocalDateTime.now());
    }
}
...
class Waiting implements BookingSearch {
    ...
    public List<Booking> getBookingsByItemsOwner(long ownerId, BookingRepository bookingRepository) {
        return bookingRepository
                .findByBooker_IdAndItem_Owner_IdAndStatusOrderByStartDesc(ownerId, BookingStatus.WAITING);
    }
}
...
class Rejected implements BookingSearch {
    ...
    public List<Booking> getBookingsByItemsOwner(long ownerId, BookingRepository bookingRepository) {
        return bookingRepository
                .findByBooker_IdAndItem_Owner_IdAndStatusOrderByStartDesc(ownerId, BookingStatus.REJECTED);
    }
}
