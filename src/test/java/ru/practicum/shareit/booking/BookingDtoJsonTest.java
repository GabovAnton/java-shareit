...
public class BookingDtoJsonTest {
    ...
    void testBookingDto() throws Exception {
        ...
        assertThat(result).extractingJsonPathStringValue("$.start")
                .isEqualTo("2022-12-08T05:05:05");
        assertThat(result).extractingJsonPathStringValue("$.end")
                .isEqualTo("2022-12-12T05:05:05");
        assertThat(result).extractingJsonPathStringValue("$.status")
                .isEqualTo("REJECTED");

        assertThat(result).extractingJsonPathValue("$.booker").extracting("name")
                .isEqualTo("Artur");
        assertThat(result).extractingJsonPathValue("$.booker").extracting("email")
                .isEqualTo("artur@gmail.com");
        assertThat(result).extractingJsonPathValue("$.booker").extracting("registrationDate")
        ...
        assertThat(result).extractingJsonPathValue("$.item").extracting("available")
                .isEqualTo(true);
        assertThat(result).extractingJsonPathValue("$.item").extracting("requestId")

                .isEqualTo(100);
        assertThat(result).extractingJsonPathValue("$.item.lastBooking").extracting("id")
                .isEqualTo(100);
        assertThat(result).extractingJsonPathValue("$.item.lastBooking").extracting("bookerId")
                .isEqualTo(100);

        assertThat(result).extractingJsonPathValue("$.item.nextBooking").extracting("id")
                .isEqualTo(100);
        assertThat(result).extractingJsonPathValue("$.item.nextBooking").extracting("bookerId")
                .isEqualTo(100);

        assertThat(result).extractingJsonPathValue("$.item.comments[0]").extracting("id")
                .isEqualTo(100);
        assertThat(result).extractingJsonPathValue("$.item.comments[0]").extracting("text")
                .isEqualTo("good thing");
        assertThat(result).extractingJsonPathValue("$.item.comments[0]").extracting("authorId")
                .isEqualTo(101);
        assertThat(result).extractingJsonPathValue("$.item.comments[0]").extracting("authorName")
                .isEqualTo("Artur");
        assertThat(result).extractingJsonPathValue("$.item.comments[0]").extracting("created")
                .isEqualTo("2022-11-25T05:05:05");
