...
class UserServiceTest {
    ...
    void getUsersShouldReturnUsersList() {
        ...
        assertThat(users).isNotEmpty().hasSize(1).extracting(UserDto::getName).contains("Artur");
    }

    @Test
    void getUserShouldReturnDto() {

        stubFor(get("/users/1").willReturn(WireMock
                .aResponse()
                .withStatus(HttpStatus.OK.value())
                .withHeader("Content-Type", "application/json")
        ...
        assertThat(user).isNotNull().extracting(UserDto::getName).isEqualTo("Artur");
    }
    ...
    void updateShouldReturnUpdatedDto() {
        ...
        stubFor(com.github.tomakehurst.wiremock.client.WireMock
                .patch(urlEqualTo("/users/1"))
                .withRequestBody(equalToJson(
                        "{\"id\" : null,\"items\" : null,\"name\" : \"Arturchik\",\"email\" : \"artur@gmail.com\",\"registrationDate\" : null,\"comments\" : null}",
                        true,
                        true))
                .willReturn(WireMock
                        .aResponse()
        ...
        assertThat(user).isNotNull().extracting(UserDto::getName).isEqualTo("Arturchik");
    }
